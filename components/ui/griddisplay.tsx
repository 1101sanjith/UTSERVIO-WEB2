...
const GridDisplay: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () =>
      setIsStuck(window.scrollY >= triggerYRef.current);
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="px-3 sm:px-4 -mt-14 sm:-mt-16 md:-mt-20 lg:-mt-24 relative z-10">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-3 sm:p-4 md:p-6 max-w-2xl mx-auto text-center relative">
          ...
          />
          <h1 className="text-base sm:text-lg md:text-xl font-semibold mt-3 sm:mt-4 mb-2">
            User Name
          </h1>
      ...
      >
        ...
        <div
          ref={containerRef}
          className="relative flex justify-center items-center space-x-2 sm:space-x-3 md:space-x-4 py-2 overflow-x-auto"
        >
          <span
            ref={underlineRef}
